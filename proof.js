...
7. 時系列の検算: 記事中の年度・季節付きの実績(「2025年春ベスト4」「23年秋ベスト4」等)を
   学校ごとに時系列表に起こし、「◯季ぶり」「◯年ぶり」「◯連覇」「初の◯◯」等の間隔・回数
   主張を機械的に検算する。例:「2025年春にベスト4」と書きながら「2026年春のベスト8以上は
   23年秋以来4季ぶり」とあれば両立しない(2025年春が挟まるため) → error。検算に必要な
   実績が記事内に揃っていない場合は矛盾とはしない(Web照合はしない)
